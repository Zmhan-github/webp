...
const outputIconMap = `export const faIconMap = new Map([
    ${keyObjectToString(
...
// function faSvgFromIcon(icon, scale = 1) {
...
//     const width = `width="${ic.width}"`
//     return `<svg ${css} ${width} ${viewBox} ${aria} ${focus} ${role} ${xmlns}><use ${href}></use></svg>`
// }
